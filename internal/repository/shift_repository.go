...
type ShiftRepository interface {
	...
	GetShiftWithMovements(shiftID uuid.UUID) (*models.Shift, error)
}
...
func (r *shiftRepository) GetShiftWithMovements(shiftID uuid.UUID) (*models.Shift, error) {
	var shift models.Shift
	err := r.db.Preload("CashMovements").First(&shift, "id = ?", shiftID).Error
	if err != nil {
		return nil, err
	}
	return &shift, nil
